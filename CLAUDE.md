...
### Big Picture
The application is a full-stack stock tracking system ("Buffet API") consisting of a Node.js/Express backend and a React/Vite frontend.
...
- **Middleware (`/src/middleware`)**: 
  - `auth.js`: JWT-based authentication (`authenticate` and `isAdmin`).
...
4. Services fetch data from PostgreSQL or the Yahoo Finance provider.
5. Data is returned as JSON and visualized in React dashboards.
